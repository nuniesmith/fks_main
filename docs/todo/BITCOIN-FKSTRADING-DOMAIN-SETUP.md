# Bitcoin Signal Demo - fkstrading.xyz Domain Setup
...
**Important**: Keep this terminal running while you use the services.
...
### Helm Values File
- **Location**: `repo/main/k8s/charts/fks-platform/values-fkstrading.yaml`
- **Domain**: fkstrading.xyz
- **Services**: fks_app, fks_data, fks_main, fks_api
- **Ingress**: Configured for fkstrading.xyz and subdomains

### Deployment Script
- **Location**: `repo/main/scripts/deploy-fkstrading-bitcoin-demo.sh`
- **Purpose**: Deploy FKS platform with domain configuration
- **Usage**: `./scripts/deploy-fkstrading-bitcoin-demo.sh`

### Ingress Configuration
- **Location**: `repo/main/k8s/ingress.yaml`
- **Domain**: fkstrading.xyz
- **Routes**: Main domain and subdomains
...
### Complete Workflow
1. **Deploy Platform**: Run `./scripts/deploy-fkstrading-bitcoin-demo.sh`
...
- ✅ **Deployment Script**: `repo/main/scripts/deploy-fkstrading-bitcoin-demo.sh`
