# Bitcoin Signal Demo - Complete Daily Workflow

**Date**: 2025-11-12  
**Status**: ✅ **READY TO USE**  
**Purpose**: Complete step-by-step daily workflow for Bitcoin signal generation and trading

---

## 🎯 Overview

This guide provides a complete step-by-step workflow for using the Bitcoin Signal Demo system for daily manual trading. The workflow takes approximately 20-25 minutes per day and includes:

1. **Morning Routine** (5 minutes) - Start services and generate signals
2. **Signal Review** (5 minutes) - Review signals from all categories
3. **Signal Approval** (5 minutes) - Approve/reject signals
4. **Manual Execution** (5 minutes) - Execute approved signals
5. **End of Day** (5 minutes) - Review performance and update logs
...
```powershell
# Generate only swing trading signals
.\repo\main\scripts\generate-daily-signals.ps1 -Symbol BTCUSDT -Categories @("swing")

# Generate scalp and swing signals
.\repo\main\scripts\generate-daily-signals.ps1 -Symbol BTCUSDT -Categories @("scalp", "swing")
```
...
- **Risk/Reward**: 1:1
- **Usage**: Active trading, short-term positions
...
- **Risk/Reward**: ~1.75:1
- **Usage**: Daily manual trading, medium-term positions
...
- **Risk/Reward**: 2:1
- **Usage**: Position trading, long-term positions
...
- **Usage**: `strategy=ema_scalp` or `strategy=ema_swing`
...
- `BITCOIN-COMPLETE-DAILY-WORKFLOW.md` - This file
