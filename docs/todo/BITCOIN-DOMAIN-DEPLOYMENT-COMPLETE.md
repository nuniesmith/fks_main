# Bitcoin Signal Demo - Domain Deployment Complete ✅
...
Your Bitcoin Signal Demo is ready to be deployed to Kubernetes with your domain `fkstrading.xyz` pointing to your Tailscale IP address `100.80.141.117`.
...
### Deployment Script
- **Location**: `repo/main/scripts/deploy-bitcoin-demo-domain.sh`
- **Purpose**: Deploy FKS platform with domain configuration
- **Usage**: `./scripts/deploy-bitcoin-demo-domain.sh`
...
- ✅ **Deployment Script**: `repo/main/scripts/deploy-bitcoin-demo-domain.sh`
